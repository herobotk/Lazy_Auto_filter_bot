...
PRIME_LOGO = (environ.get('PRIME_LOGO', 'https://i.postimg.cc/FK9CrRMd/IMG-20250723-085849-1.jpg'))

# Admins, Channels & Users *
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002172427490').split()]
...
# Others
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/lucifer_movie_talk/251') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Movie_Talk_support')
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','thakur_m_10') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','+X5RPKIsoDgtlZGFl') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','lucifer_movie_talk') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "+eskkZj6K321kZDI1") #[ without @ ]
...
DOWNLOAD_TEXT_URL = "https://t.me/lucifer_movie_talk/251"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/movie_talk_backup"
